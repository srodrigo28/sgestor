preciso que crie um sql para rodar dentro do meu banco para pegar e cadastrar 20 tarefas para o user_id = 4 que pegue inserção para os últimos 7 dias para testar o gráfico.
